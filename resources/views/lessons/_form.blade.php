...
<div class="mb-4">
    ...
    <textarea name="content" rows="5"
              class="w-full rounded p-2 bg-gray-100 dark:bg-gray-700 text-black dark:text-white"
              required>{{ old('content', $lesson->content ?? '') }}</textarea>
</div>

<div class="mb-4">
    <label class="block text-gray-700 dark:text-gray-300 mb-1">Difficulty</label>
    <select name="difficulty" class="w-full rounded p-2 bg-gray-100 dark:bg-gray-700 text-black dark:text-white" required>
