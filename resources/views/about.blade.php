            ...
            <div class="overflow-x-hidden">
                ...
                <div class="animated-gradient text-white">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20 md:py-32">
                        ...
                        <p class="mt-4 md:mt-6 max-w-2xl mx-auto text-lg md:text-xl text-gray-300 reveal"
                            ...
                            dirancang secara ahli dan terstruktur, dari tingkat dasar hingga mahir, untuk memastikan
                            setiap
                            langkah pembelajaran Anda optimal. Dapatkan bimbingan dari mentor berpengalaman dan raih
                            kompetensi
                ...
                <div class="py-20 bg-gray-800">
                    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="relative">
                            <div
                                class="hidden md:block absolute w-0.5 h-full bg-gray-700 left-1/2 transform -translate-x-1/2">
                            </div>
                            ...
                            <div class="mb-8 flex justify-between items-center w-full right-timeline reveal">
                                ...
                                <div class="bg-gray-900 glass-card p-6 rounded-lg w-full md:w-5/12">
                                    ...
                                    <p class="text-gray-400 mt-2">Berawal dari lima mahasiswa yang tidak menghadiri
                                        perkuliahan
                            ...
                            <div
                                class="mb-8 flex justify-between md:flex-row-reverse items-center w-full left-timeline reveal">
                                <div class="hidden md:block w-5/12"></div>
                                <div class="z-20 flex items-center bg-yellow-500 w-8 h-8 rounded-full"></div>
                                <div class="bg-gray-900 glass-card p-6 rounded-lg w-full md:w-5/12">
                                    <p class="text-yellow-500 font-semibold">April 2025</p>
                                    <h3 class="text-xl font-bold text-white mt-1">Gagasan Lahir</h3>
                                    <p class="text-gray-400 mt-2">Sebuah ide sederhana tercetus untuk menciptakan
                                        platform
                            ...
                            <div class="mb-8 flex justify-between items-center w-full right-timeline reveal">
                                ...
                                <div class="bg-gray-900 glass-card p-6 rounded-lg w-full md:w-5/12">
                                    ...
                                    <p class="text-gray-400 mt-2">Setelah melalui berbulan-bulan penuh perjuangan, kerja
                                        keras
                                        tanpa henti, dan proses pengembangan yang tak selalu mulus, akhirnya—Pinterin
                                        sudah siap
                            ...
                            @php
                                $developers = [
                                    ...
                                    [
                                        ...
                                        'img' =>
                                            'https://i.pinimg.com/474x/be/a9/f2/bea9f287b6e10df744a59b573248bdb8.jpg',
                                    ],
                                    [
