        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">{{ floor($course->duration / 60) }}h {{ $course->duration % 60 }}m</p>
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Price: ${{ number_format($course->price, 2) }}</p>
            ...
            @if(auth()->user()?->is_admin)
                <div class="flex justify-end">
                    <a href="{{ route('courses.edit', $course) }}" class="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600">Edit Course</a>
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <div class="flex items-center gap-4 mt-2 text-sm font-semibold">
                                    <span class="block text-white opacity-80">{{ ucfirst($lesson->difficulty->value) }}</span>
                                    <div class="flex items-center">
                                        ...
                                        <span>{{ floor($lesson->duration / 60) }}h {{ $lesson->duration % 60 }}m</span>
                                    </div>
                                </div>
                            </div>
                            <div>
